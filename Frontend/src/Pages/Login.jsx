    ...
    <div className="relative flex min-h-screen flex-col bg-[#162013] overflow-x-hidden" style={{ fontFamily: "Manrope, 'Noto Sans', sans-serif" }}>
      <div className="px-40 flex flex-1 justify-center py-5">
        <div className="flex flex-col w-full max-w-[512px] py-5">
          <h2 className="text-white text-[28px] font-bold px-4 text-center pb-3 pt-5">Welcome back</h2>
          ...
          <div className="flex px-4 py-3">
            <button onClick={handleLogin} className="flex-1 rounded-full h-12 px-5 bg-[#50d22c] text-[#162013] text-base font-bold">Log in</button>
          </div>
          <p className="text-[#a1c398] text-sm text-center underline cursor-pointer" onClick={() => navigate("/signup")}>Don't have an account? Sign up</p>
        </div>
      </div>
    </div>
  );
